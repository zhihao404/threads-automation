...
export interface SettingsUsageItem {
  type: string;
  current: number;
  limit: number;
  remaining: number;
...
interface SettingsClientProps {
  initialData: SettingsAccountData;
  initialUsageData: SettingsUsageData | null;
}

export function SettingsClient({ initialData, initialUsageData }: SettingsClientProps) {
  const data = initialData;
  const usageData = initialUsageData;
